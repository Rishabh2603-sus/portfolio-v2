...
function App() {
  ...
  return (
    <div className="bg-[#050505] text-[#fafafa] min-h-screen selection:bg-white/20 font-sans font-light relative overflow-hidden">
      ...
      <Navbar />
      <main className="px-6 md:px-12 lg:px-24 mx-auto max-w-7xl relative z-10">
        <HeroSection />
        <ProjectsSection />
        <ExperienceSection />
        <SkillsSection />
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-8 text-sm font-medium">
        ...
        <a href="#experience" className="text-neutral-400 hover:text-white transition-colors hidden sm:inline-block">
          Experience
        </a>
        <a href="#capabilities" className="text-neutral-400 hover:text-white transition-colors hidden sm:inline-block">
          Capabilities
        </a>
        <a
          href="/resume.docx"
...
function SkillsSection() {
  return (
    <section id="capabilities" className="py-32 border-t border-white/[0.06]">
      <div className="flex flex-col md:flex-row gap-12 md:gap-24">
        <div className="md:w-1/3">
          <h2 className="text-2xl font-medium tracking-tight sticky top-32 text-neutral-200">
            Capabilities
        ...
        <div className="md:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-16 md:gap-20">
